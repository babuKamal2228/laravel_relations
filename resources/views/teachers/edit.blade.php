            ...
            <form action={{ route('teachers.store') }} method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" name="name" placeholder="License No">
                       <span class="text text-danger"> @error('name'){{ $message }}@enderror
                         </span>
                        </br>
                        <label for="teacher_firstname">First Name:</label>
                        <input class="form-control" type="text" name="teacher_firstname" placeholder="Father-Name">
                       ...
                       <span class="text text-danger"> @error('date_of_birth'){{ $message }}@enderror</span>
                        ...
                        <input class="form-control" type="text" name="teacher_designation" placeholder="teacher_designation">
